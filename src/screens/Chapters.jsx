  ...
  const [chapterData, setChapterData] = useState([
    {
      ...
      chpaterNameTranslation: "The Opening",
      noOfNotes: 0,
      noOfParagraphs: 1,
      isMadani: false,
      surahNumber: 1,
        ...
        return (
          <div className="chapterDetailDiv" key={chapterDataObj.noOfVerses}>
            <div className="cahpterBreifInfo">
              <h1 className="chapterNumHeading">
                {chapterDataObj.surahNumber}
              </h1>
              <div className="surahTypeView">
                <img class="surahTypeImgView" src={makkahIcon}></img>
              </div>
              <span className="versesCount">
                {chapterDataObj.noOfVerses}verses
              </span>
            </div>
            <div className="chapterDetailInfo">
              <h1 className="surahNameTranslationHeading">
                {chapterDataObj.chpaterNameTranslation}
              </h1>
              <h2 className="surahNameHeading">{chapterDataObj.chpaterName}</h2>
              <div className="paraAndNoteDiv">
                <span className="paraAndNoteCount">
                  {chapterDataObj.noOfParagraphs} Paragraph
                </span>
                <span className="paraAndNoteCount">
                  {chapterDataObj.noOfNotes} Notes
                </span>
              </div>
            </div>
          </div>
